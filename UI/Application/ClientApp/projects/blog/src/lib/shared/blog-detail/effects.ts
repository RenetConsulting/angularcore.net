...
export class BlogDetailEffects {
    ...
    constructor(
     ...
     getBlogRequest = createEffect(() => this.actions.pipe(
     ...
     updateBlogRequest = createEffect(() => this.actions.pipe(
     ...
     deleteBlogPreRequest = createEffect(() => this.actions.pipe(
     ...
     deleteBlogRequest = createEffect(() => this.actions.pipe(
     ...
     navigateBlogs = createEffect(() => this.actions.pipe(
